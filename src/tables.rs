...
//!
//! These tables are direct ports from PKLib's PKWareLUTs.c and must remain
//! byte-for-byte compatible with the original implementation.

/// Number of distance codes
pub const DIST_SIZES: usize = 64;

/// Number of ASCII character codes
pub const CH_BITS_ASC_SIZE: usize = 256;

/// Number of length codes
pub const LENS_SIZES: usize = 16;

/// Distance bits table - number of bits to read for each distance code
pub const DIST_BITS: [u8; DIST_SIZES] = [
...
/// Distance codes table - used to build distance position lookup
pub const DIST_CODE: [u8; DIST_SIZES] = [
...
/// Extra length bits table - additional bits to read for length codes
pub const EX_LEN_BITS: [u8; LENS_SIZES] = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
];

/// Length base values table
pub const LEN_BASE: [u16; LENS_SIZES] = [
    0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007, 0x0008, 0x000A, 0x000E, 0x0016,
    0x0026, 0x0046, 0x0086, 0x0106,
];

/// Length bits table - number of bits for each length code
pub const LEN_BITS: [u8; LENS_SIZES] = [
    0x03, 0x02, 0x03, 0x03, 0x04, 0x04, 0x04, 0x05, 0x05, 0x05, 0x05, 0x06, 0x06, 0x06, 0x07, 0x07,
];

/// Length codes table
pub const LEN_CODE: [u8; LENS_SIZES] = [
    0x05, 0x03, 0x01, 0x06, 0x0A, 0x02, 0x0C, 0x14, 0x04, 0x18, 0x08, 0x30, 0x10, 0x20, 0x40, 0x00,
];

/// ASCII character bit lengths table - used for ASCII compression mode
pub const CH_BITS_ASC: [u8; CH_BITS_ASC_SIZE] = [
...
/// ASCII character codes table - used for ASCII compression mode
pub const CH_CODE_ASC: [u16; CH_BITS_ASC_SIZE] = [
